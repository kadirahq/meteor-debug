...
KadiraDebug._init = function(browserId, clientId) {
  ...
  var debug = getQueryParamFromURI("debug");
  var accessToken = getQueryParamFromURI("access_token") || null;

  Meteor.subscribe('kadira.debug.init', browserId, clientId, accessToken);
