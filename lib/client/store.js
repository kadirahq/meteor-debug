...
Store.prototype.start = function(browserId, clientId) {
  ...
  // XXX: If this is already started, we don't need to do anything
...
Store.prototype.trackActivity = function(type, name) {
  var self = this;
  // XXX: need to find a better way to check the start state of the store
  if(!self._clientId) {
    return function() {};
  }
...
Store.prototype.trackGuage = function(key, value, options) {
  // XXX: If not started, we don't need to do return right away
  options = options || {};
