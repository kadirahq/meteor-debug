...
Meteor.publish('kadira.debug.client.init', function(browserId, clientId, accessToken) {
...
Meteor.methods({
  ...
  'kadira.debug.admin.getTrace': function(browserId, clientId, type, id) {
    check(browserId, String);
    check(clientId, String);
    check(type, String);
    check(id, String);
  ...
  'kadira.debug.admin.getAppEnv': function() {
    return AppConfig.env;
  },

  'kadira.debug.admin.createAccessToken': function() {
    var kadiraInfo = Kadira._getInfo();
    var sessionId = kadiraInfo.session;
  ...
  'kadira.debug.admin.resetAccessToken': function() {
    var kadiraInfo = Kadira._getInfo();
    var sessionId = kadiraInfo.session;
  ...
  'kadira.debug.admin.reset': function() {
...
Meteor.publish('kadira.debug.admin.timeline', function(authKey) {
